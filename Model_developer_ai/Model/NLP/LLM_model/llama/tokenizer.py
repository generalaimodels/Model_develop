...
# import os
# # Assuming you have a Tiktoken model file named "model.tiktoken"
...
# # Create an instance of the ChatFormat class
# chat_format = ChatFormat(tokenizer)

# # Test the encode_message and encode_dialog_prompt methods
...
# ]
# encoded_dialog_prompt = chat_format.encode_dialog_prompt(dialog)

# print("Encoded message:", tokenizer.decode(encoded_message))
# print("Encoded dialog prompt:", tokenizer.decode(encoded_dialog_prompt))