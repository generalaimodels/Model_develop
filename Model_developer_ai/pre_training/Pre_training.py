...
def parse_args():
    ...
    parser.add_argument(
        "--use_slow_tokenizer",
        action="store_true",
        help="If passed, will use a slow tokenizer (not backed by theTokenizers library).",
    )
    parser.add_argument(
...
def main():
    ...
    config_args = load_arguments_from_yaml(yaml_file_path='C:/Users/heman/Desktop/Coding/LLMs/pre_training/Pre_training_config.yml')
