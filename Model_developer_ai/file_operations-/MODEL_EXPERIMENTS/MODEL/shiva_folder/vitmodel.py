...
class ViT(nn.Module):
    ...
    def forward(self, test_input: torch.Tensor) -> torch.Tensor:
...
if __name__ == '__main__':
    # Define dummy input tensor (batch_size, channels, height, width)
    dummy_input = torch.randn(10, 3, 224, 224)  # Example: RGB image with size 224x224
    ...
    args = {
        ...
        'num_classes': 10,
        'batch_size': 10,
        'no_cuda': True  # Set to True if CUDA is not available
    }
