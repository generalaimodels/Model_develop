...
config_args = load_arguments_from_yaml('')
for key, value in config_args.items():
...
print(args)
# config_args = load_arguments_from_yaml('C:/Users/heman/Desktop/Deep learning/testing/file_operations-/File_and_Operations/transformers_peft_trl/Fine-tuning/General_fine_tuning/training.yml')
# for key, value in config_args.items():
#     setattr(args, key, value)
